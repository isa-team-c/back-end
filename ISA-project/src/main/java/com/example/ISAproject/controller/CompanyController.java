...
public class CompanyController {
	...
	@GetMapping("/search")
	public ResponseEntity<List<Company>> searchCompanies(@RequestParam(required = false) String searchTerm) {
	...
	/*
	 * @PostMapping public ResponseEntity<CompanyDto> saveCompany(@RequestBody
	 ...
	 * 
	 * Company company = new Company(); company.setName(companyDTO.getName());
	 * company.setAddress(companyDTO.getAddress());
	 * company.setDescription(companyDTO.getDescription());
	 * company.setAverageRating(companyDTO.getAverageRating());
	 * 
	 * company = companyService.save(company); return new ResponseEntity<>(new
	 * CompanyDto(company), HttpStatus.CREATED); }
	 */

	@PutMapping("/update")
	public ResponseEntity<CompanyDto> updateCompanyProfile(@RequestBody CompanyDto updatedCompanyDto) {
	...
	/*
	 * @GetMapping("/company/{administratorId}") public ResponseEntity<Company>
	 * getCompanyByAdministratorId(@PathVariable Long administratorId) { Company
	 * company = companyService.getCompanyByAdministratorId(administratorId);
	 * 
