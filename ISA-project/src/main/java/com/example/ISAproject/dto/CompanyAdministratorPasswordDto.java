...
public class CompanyAdministratorPasswordDto {
	private long id;
    private UserDto user;
    private CompanyDto companyDto;
    private boolean loggedInBefore;

    public CompanyAdministratorPasswordDto() {
    }

    public CompanyAdministratorPasswordDto(CompanyAdministrator companyAdministrator) {
